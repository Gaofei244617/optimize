...
namespace opt
{
    ...
    public:
        ...
        void setThreadNum(const std::size_t N);     // 设置线程数量

        void cross_sync(const std::size_t thread_seq);      // "交叉"线程同步
        void mutate_sync(const std::size_t thread_seq);     // "变异"线程同步
        void select_sync(const std::size_t thread_seq);     // "选择"线程同步
    };
    ...
    // “交叉”线程同步
    template<class R, class... Args>
    void GAThreadSync<R, Args...>::cross_sync(const std::size_t thread_seq)
    {
    ...
    // "变异"线程同步
    template<class R, class... Args>
    void GAThreadSync<R, Args...>::mutate_sync(const std::size_t thread_seq)
    {
    ...
    // "选择"线程同步
    template<class R, class... Args>
    void GAThreadSync<R, Args...>::select_sync(const std::size_t thread_seq)
    {
